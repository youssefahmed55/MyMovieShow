...
public class MyRecycleAdapter2 extends  RecyclerView.Adapter<MyRecycleAdapter2.Holder> {
    private ArrayList<Result2> arrayList;
    private Context context;
    private OnmyClickListenerrr2 onmyClickListenerrr2;
    public MyRecycleAdapter2(Context context) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item2,parent,false)) ;
    }
    ...
    public int getItemCount() {
     ...
     class Holder extends RecyclerView.ViewHolder{
        ...
        public Holder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.imageofmovie_list2);
            textView1 = itemView.findViewById(R.id.nameofmovie_list2);
            textView2 = itemView.findViewById(R.id.Detailsofmovie_list2);
            textView3 = itemView.findViewById(R.id.rateofmovie_list2);
